        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-8">
              <p>
                Already have an account? <span className="text-red-600 hover:text-red-700 transition duration-2 ease-in-out"><Link to="/sign-in">Sign In!</Link></span>
              </p>
            ...
            <div>
                <button submit={handleSignUp} className="bg-blue-600 w-full py-2 rounded text-white mb-4 text-sm font-medium uppercase shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800">
                  Sign Up
                </button>
            </div>
